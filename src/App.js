...
const questions = [
  ...
  {
    question: "Как называется теория, по которой наша реальность зависит от восприятия и сознания?",
    options: ["Реализм", "Конструктивизм", "Идеализм", "Плюрализм"],
    correctAnswer: "Идеализм",
  },
